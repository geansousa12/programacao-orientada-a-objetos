...
public class Lapiseira {
    ...
    //variavel pra saber se tem grafite
    private boolean graf = false;
    // variavel pra saber a quantidade de linhas
    private int linhas;
    ...
    public void InserirGrafite() {
        ...
        if (in.nextInt() == 1) {
            Grafite gra = new Grafite();//novo obejeto pra chamar o metodo construtor e verificar se é compátivel
            if (this.getCalibre() == gra.getCalibre()) {
                graf = true;//se for compativel graf recebe o grafite
             
                //linhas = 0
                this.setLinhas(0);
                
                System.out.println("Deseja escrever uma linha?\n0 - Não, 1 - Sim");
                int q = in.nextInt();// variavel criada so pra ceceber o 0 ou o 1
                while (q == 1) {
                    EscreverLinhas();
    ...
    public void EscreverLinhas() {
        //Se tiver grafite e tiver menos de 20 linhas
